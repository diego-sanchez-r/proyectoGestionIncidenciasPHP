 ...
 */
final class Version20220304122417 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE incidencias (id INT AUTO_INCREMENT NOT NULL, titulo VARCHAR(255) NOT NULL, fecha_creacion DATETIME NOT NULL, estado VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
