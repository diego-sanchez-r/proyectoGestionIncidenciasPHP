 ...
 */
final class Version20220304153042 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE incidencias_user (incidencias_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_746D990A9945E2A (incidencias_id), INDEX IDX_746D990A76ED395 (user_id), PRIMARY KEY(incidencias_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE incidencias ADD cliente_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE incidencias DROP cliente_id, CHANGE titulo titulo VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE estado estado VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
